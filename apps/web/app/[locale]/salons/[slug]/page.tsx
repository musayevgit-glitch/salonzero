        ...
        >
          ...
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to top, rgba(30,27,46,0.9), rgba(30,27,46,0.2))',
            }}
          />
          <div
            style={{
          ...
          >
            ...
            >
              {salon.city && (
                <span style={{ color: '#e4d4f4', fontSize: '0.875rem' }}>{salon.city}</span>
              )}
              {salon.genderFocus && (
                <span
                  style={{
                ...
                >
                  {salon.genderFocus === 'WOMEN'
                    ? t('genderWomen')
                    : salon.genderFocus === 'MEN'
                      ? t('genderMen')
                      : t('genderUnisex')}
                </span>
              )}
              ...
              {typeof salon.avgRating === 'number' && salon.ratingCount > 0 ? (
                ...
                >
                  ...
                  {tr('ratingWithCount', {
                    rating: salon.avgRating.toFixed(1),
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {salon.description && (
              ...
              >
                ...
                <p style={{ color: '#6b5d8a', fontSize: '0.95rem', lineHeight: 1.6, margin: 0 }}>
                  {salon.description}
                </p>
              </section>
            )}
            ...
            >
              ...
              {hasServices ? (
                        ...
                        {category.services.map((s, idx) => (
                          <li
                            ...
                            style={{
                              ...
                              padding: '1rem 0',
                              borderBottom:
                                idx < category.services.length - 1 ? '1px solid #e4d4f4' : 'none',
                            }}
                          >
                            <div
                            ...
                            >
                              ...
                              <span style={{ color: '#7c6fa0', fontSize: '0.85rem' }}>
                                {s.durationMinutes} {t('min')}
                              </span>
                            </div>
                            <span style={{ color: '#1e1b2e', fontWeight: 600 }}>
                              {formatMoney(s.priceAmount)}
                            </span>
                          </li>
                        ))}
                      </ul>
                        ...
                        {salon.uncategorizedServices.map((s, idx) => (
                          <li
                            ...
                            style={{
                              ...
                              padding: '1rem 0',
                              borderBottom:
                                idx < salon.uncategorizedServices.length - 1
                                  ? '1px solid #e4d4f4'
                                  : 'none',
                            }}
                          >
                ...
                <p style={{ color: '#7c6fa0', fontSize: '0.95rem', margin: 0 }}>
                  {t('noServices')}
                </p>
              )}
            </section>
                  ...
                  {salon.approximateOpeningHours.map((h) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span style={{ color: '#1e1b2e', fontWeight: 600 }}>
                          {formatMinuteOfDay(h.startMinuteOfDay)} –{' '}
                          {formatMinuteOfDay(h.endMinuteOfDay)}
                        </span>
                      </div>
                    );
                  })}
                ...
                >
                  <li>
                    {salon.bookingPolicySummary.autoConfirm
                      ? 'Rezervasiyalar anında təsdiqlənir.'
                      : 'Rezervasiyalar üçün salonun təsdiqi tələb olunur.'}
                  </li>
                  <li>
                    Təyinatdan {salon.bookingPolicySummary.cancellationWindowHours} saat əvvələ
                    qədər ləğv etmək mümkündür.
                  </li>
                  <li>
                    Təyinatdan {salon.bookingPolicySummary.rescheduleWindowHours} saat əvvələ qədər
                    vaxtı dəyişmək mümkündür.
                  </li>
                </ul>
              </section>
            )}
