    ...
    return (
      <PageLayout isAuthenticated={isAuthenticated}>
        <div style={{ textAlign: 'center', padding: '4rem 1rem' }}>
          <h1 style={{ fontSize: '1.5rem', color: '#1e1b2e', marginBottom: '0.5rem' }}>Couldn't load this salon</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem' }} className="lg-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            {salon.description && (
              <section style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem' }}>
                <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', marginBottom: '1rem', fontWeight: 600, margin: '0 0 1rem 0' }}>Haqqında</h2>
                <p style={{ color: '#6b5d8a', fontSize: '0.95rem', lineHeight: 1.6, margin: 0 }}>{salon.description}</p>
              </section>
            )}

            <section style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem' }}>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', marginBottom: '1rem', fontWeight: 600, margin: '0 0 1rem 0' }}>Xidmətlər</h2>
              {hasServices ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        {category.services.map((s, idx) => (
                          <li key={s.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 0', borderBottom: idx < category.services.length - 1 ? '1px solid #e4d4f4' : 'none' }}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                              ...
                              <span style={{ color: '#7c6fa0', fontSize: '0.85rem' }}>{s.durationMinutes} dəq</span>
                            </div>
                ...
                <p style={{ color: '#7c6fa0', fontSize: '0.95rem', margin: 0 }}>Hələ xidmət əlavə edilməyib.</p>
              )}
            </section>

            <section style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem' }}>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', marginBottom: '1rem', fontWeight: 600, margin: '0 0 1rem 0' }}>Ustalar</h2>
              {salon.employees.length > 0 ? (
                ...
                <p style={{ color: '#7c6fa0', fontSize: '0.95rem', margin: 0 }}>Hələ usta əlavə edilməyib.</p>
              )}
            </section>

            {salon.approximateOpeningHours.length > 0 && (
              <section style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem' }}>
                <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', marginBottom: '1rem', fontWeight: 600, margin: '0 0 1rem 0' }}>İş saatları</h2>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {salon.approximateOpeningHours.map(h => (
                    <div key={h.weekday} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '0.75rem', borderBottom: '1px solid #f5f0eb' }}>
                      <span style={{ color: '#6b5d8a', fontWeight: 500 }}>{WEEKDAY_LABEL[h.weekday]}</span>
            ...
            {salon.bookingPolicySummary && (
              <section style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem' }}>
                <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', marginBottom: '1rem', fontWeight: 600, margin: '0 0 1rem 0' }}>Rezervasiya qaydaları</h2>
          ...
          <div className="booking-sidebar" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div className="booking-card" style={{ background: 'white', borderRadius: 16, border: '1px solid #e4d4f4', padding: '1.5rem', position: 'sticky', top: '5.5rem' }}>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: '#1e1b2e', margin: '0 0 0.5rem 0', fontWeight: 600 }}>Rezervasiya</h2>
              <p style={{ color: '#6b5d8a', fontSize: '0.9rem', marginBottom: '1.5rem', marginTop: 0 }}>Uyğun vaxtı seçmək üçün davam edin.</p>
